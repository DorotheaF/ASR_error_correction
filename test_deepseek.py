...
# finished = "e2e99d2e-845a-028a-e65c-854944a6de7d", "75beca5b-c81c-3d10-e998-37035d39761d",
...
for file in transcripts_test:
    print(tran_num)
    tran_num += 1
    file_name = location + "data/test_files/" + file + ".xlsx"
